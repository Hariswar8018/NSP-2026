...
import 'package:nsp2026/admin/create_user.dart';
import 'package:nsp2026/model/constituency.dart';
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SwitchListTile(
                        title: const Text("Upload Access"),
                        value: u.isuploaddata,
                        onChanged: (v) =>
                            updateField(u.id, "isuploaddata", v),
                      ),
